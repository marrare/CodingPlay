...
SessaoDao.prototype.finalizar = function(sessao, callback){
	this._connection.query("update sessao set hora_inicio_realizado = '"+sessao.horaInicio+"', hora_final_realizado = '"+sessao.horaFinal+"', resposta_sessao_realizada = '"+sessao.resposta+"', chat_sessao_realizada = '"+sessao.chat+"', situacao = 0 WHERE id = '"+sessao.sessao_id+"' ", sessao, callback);
}
