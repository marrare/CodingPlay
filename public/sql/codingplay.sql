...
INSERT INTO `problema`(`id_Professor`, `desc_Problema`, `dificuldade`) VALUES (1,'Criar uma variável idade, adicionar 20 ao seu valor e imprimi-la.','F');
INSERT INTO `problema`(`id_Professor`, `desc_Problema`, `dificuldade`) VALUES (1,'Encontrar a média da soma destes valores: 7,8,8,5,4','F');
